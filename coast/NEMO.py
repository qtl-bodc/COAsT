...
class NEMO(COAsT):
    ...
    def __init__(self, fn_data=None, fn_domain=None, grid_ref='t-grid',
        ...
        if fn_domain is None:
            ...
            self.set_timezero_depths(
                dataset_domain)  # THIS ADDS TO dataset_domain. Should it be 'return'ed (as in trim_domain_size) or is implicit OK?
    ...
    def set_timezero_depths(self, dataset_domain):
        ...
        try:
            ...
            # depth_0 = da.zeros_like(e3w_0)
            # depth_0[0, :, :] = 0.5 * e3w_0[0, :, :]
            # depth_0[1:, :, :] = depth_0[0, :, :] + da.cumsum(e3w_0[1:, :, :], axis=0)
            ...
            # Write the depth_0 variable to the domain_dataset DataSet, with grid
